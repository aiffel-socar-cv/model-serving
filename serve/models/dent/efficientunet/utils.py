...
CHECKPOINT_DIR = os.path.join(os.getcwd(), "efficientunet", "checkpoint")
# print(CHECKPOINT_DIR)
checkpoint_list = glob(os.path.join(CHECKPOINT_DIR, "*.pt"))
assert checkpoint_list, Colors.RED + "Backbone network checkpoint doesn't exist!!" + Colors.RESET
if checkpoint_list:
    STANFORD_CHECKPOINT = os.path.join(CHECKPOINT_DIR, checkpoint_list[0])
    print("BACKBONE:", Colors.GREEN, STANFORD_CHECKPOINT, Colors.RESET)
...
IMAGENET_WEIGHTS = {
    ...
    "efficientnet-b4-stanford": f"{STANFORD_CHECKPOINT}",
}
...
if __name__ == "__main__":
    print(STANFORD_CHECKPOINT)
    print(IMAGENET_WEIGHTS["efficientnet-b4-stanford"])
